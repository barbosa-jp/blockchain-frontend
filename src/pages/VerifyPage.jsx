    ...
    try {
      ...
      if (verifyMethod === 'id') {
        ...
        try {
          ...
          console.log('📄 Hash do PDF calculado:', fileHash);
          
          const [isValid, certData] = await contract.verifyByHash(fileHash);
          console.log('🔍 Resultado da verificação:', { isValid, certData });
          ...
          if (isValid && certData) {
            ...
            setResult({
              ...
              hash: fileHash,
              details: {
                note: 'O hash do PDF não corresponde a nenhum certificado registrado na blockchain.'
              }
            });
            toast.error('❌ Certificado não encontrado. Verifique se o PDF é o original.');
          }
        } catch (err) {
        ...
        {verifyMethod === 'id' ? (
          ...
          <div>
            ...
            <div className="space-y-3">
              ...
              <p className="text-xs text-gray-500 mt-1">
                Faça o upload do PDF original emitido pelo sistema
              </p>
            </div>
          </div>
        )}
          ...
          <div className={`p-4 rounded-lg border ${
            ...
            <div className="flex items-start space-x-3">
              ...
              <div className="flex-1">
                ...
                {!result.isValid && result.details?.note && (
                ...
                {!result.isValid && !result.details?.note && (
                  <div className="mt-2 text-sm text-gray-600">
                    <p>O certificado não foi encontrado na blockchain.</p>
                    <ul className="list-disc list-inside mt-1 text-xs text-gray-500">
                      ...
                      <li>O certificado pode não existir</li>
                    </ul>
                  </div>
                )}
              </div>
          ...
          <div className="flex items-start space-x-2">
            ...
            <div className="text-sm text-blue-700">
              ...
              <p className="text-xs text-blue-600 mt-1">
                {verifyMethod === 'id' 
                  ? 'Use o ID para verificar rapidamente qualquer certificado.'
                  : 'Faça o upload do PDF original para verificar sua autenticidade.'}
              </p>
            </div>
          </div>
        </div>
