...
import { Search, Loader2, CheckCircle, XCircle, AlertCircle, Hash } from 'lucide-react';
    ...
    <div className="max-w-2xl mx-auto">
      ...
      <div className="card space-y-6">
        <div className="flex items-center space-x-2 text-sm text-gray-500">
          <Hash size={16} />
          <span>Verifique a autenticidade de um certificado usando seu ID único</span>
        </div>
        ...
        <div>
          ...
          <div className="flex space-x-3">
            <input
              ...
              placeholder="Digite o ID do certificado (ex: 1, 2, 3...)"
              disabled={isLoading}
              min="1"
            />
            <button
          ...
          <p className="text-xs text-gray-500 mt-1">
            Digite o ID numérico que você recebeu ao emitir o certificado
          </p>
        </div>
                  ...
                  <div className="mt-3 space-y-2 text-sm">
                    ...
                    <div className="mt-2 pt-2 border-t border-gray-200">
                      <p className="text-xs text-gray-500 break-all">
                        <strong>Hash do Documento:</strong> {result.details.documentHash}
                      </p>
                    </div>
                  </div>
                )}
          ...
          <div className="flex items-start space-x-2">
            ...
            <div className="text-sm text-blue-700">
              ...
              <p className="text-xs text-blue-600 mt-1">
                Qualquer pessoa pode verificar a autenticidade de um certificado usando o ID.
              </p>
            </div>
          </div>
        </div>
